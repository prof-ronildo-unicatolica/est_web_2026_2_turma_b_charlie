      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <div className="d-flex align-items-center gap-2">
            {/* dropdown admin - visivel apenas para admins logados */}
            {user?.is_admin && (
              <div className="dropdown me-2">
                ...
                <ul className="dropdown-menu dropdown-menu-end">
                  ...
                  <li><Link className="dropdown-item" to="/admin/hoteis">Hoteis</Link></li>
      ...
      <header className="mb-5 p-4 bg-white rounded shadow-sm">
        ...
        <div className="row g-3">
          <div className="col-md-3 col-sm-6">
            <strong>Equipe:</strong> <span className="text-secondary ms-1">{data?.equipe || 'Charlie'}</span>
          </div>
          <div className="col-md-3 col-sm-6">
    ...
    <BrowserRouter>
      <div className="bg-light min-vh-100 pb-5">
        ...
        <Routes>
          ...
          <Route path="/admin/hoteis"
            element={<AdminRoute><AdminHoteisPage /></AdminRoute>} />
          <Route path="/admin/comodidades"
